...
function Input({
    ...
    return (
        ...
        >
            ...
            <div className={cls('input-addon', styles.inputGroup)} data-has-addon={!!addonBefore || !!addonAfter}>
                {addonBefore && <span className={cls('addon', styles.addonBefore)}>{addonBefore}</span>}
                <input
                    {...rest}
                    style={style}
                    tabIndex={0}
                    ...
                    onChange={_onChange}
                />
                {addonAfter && <span className={cls('addon', styles.addonAfter)}>{addonAfter}</span>}
            </div>
            {rightSection && (
